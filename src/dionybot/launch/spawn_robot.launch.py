...
def generate_launch_description():
    ...
    gz_bridge_node = Node(
        ...
        remappings=[
            ...
            (
                "/world/sonoma/model/dionybot/link/base_link/sensor/imu_sensor/imu",
                "/imu",
            ),
            (
                "/world/sonoma/model/dionybot/link/base_link/sensor/navsat_sensor/navsat",
                "/fix",
            ),
