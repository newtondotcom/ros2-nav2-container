...
def generate_launch_description():
    ...
    robot_sdf = os.path.join(tutorial_dir, "urdf", "gz_waffle_gps.sdf.xacro")

    urdf = os.path.join(tutorial_dir, "urdf", "turtlebot3_waffle_gps.urdf")
    ...
    gz_robot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(tutorial_dir, "launch", "spawn_tb3_gps.launch.py")
        ),
        launch_arguments={
